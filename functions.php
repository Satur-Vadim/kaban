<?php
/**
 * kaban functions and definitions
 *
...
if ( ! function_exists( 'kaban_setup' ) ) :
	/**
	 ...
	 */
	function kaban_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on kaban, use a find and replace
		 * to change 'kaban' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'kaban', get_template_directory() . '/languages' );
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'kaban' ),
		) );
		register_nav_menus( array(
			'menu-2' => esc_html__( 'Secondary', 'kaban' ),
		) );
		register_nav_menus( array(
			'menu-3' => esc_html__( 'Footer', 'kaban' ),
		) );
		...
		add_theme_support( 'custom-background', apply_filters( 'kaban_custom_background_args', array(
...
add_action( 'after_setup_theme', 'kaban_setup' );
 ...
 */
function kaban_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'kaban_content_width', 640 );
}
add_action( 'after_setup_theme', 'kaban_content_width', 0 );
 ...
 */
function kaban_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'kaban' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'kaban' ),
...
add_action( 'widgets_init', 'kaban_widgets_init' );

/**
 * Enqueue scripts and styles.
 */
function kaban_scripts() {
	wp_enqueue_style( 'kaban-style', get_stylesheet_uri() );

	wp_enqueue_script( 'kaban-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'kaban-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );

	if ( is_singular() && comments_open() && get_option( 'thread_comments' ) ) {
		wp_enqueue_script( 'comment-reply' );
	}
}
add_action( 'wp_enqueue_scripts', 'kaban_scripts' );
...
final class Sheensay_Product {
    ...
    function __construct( $post_type = "" ) {
         ...
         */
        add_action( 'init', array( $this, 'sheensay_cpt_product' ) );
    ...
    function sheensay_cpt_product() {
    	
   		register_taxonomy('shop',array( 'products' ),$args);
        ...
        $args = array(
            ...
            'rewrite' => array(
                'slug' => $this -> post_type . '/%sheensay_product_type%',
                'with_front' => false,
            ),
